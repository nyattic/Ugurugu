...
constexpr auto repositoryUrl =
    "https://github.com/nyattic/WagleWaglePaint";

std::unique_ptr<Velopack::UpdateManager> createUpdateManager()
{
    auto source =
        std::make_unique<Velopack::GithubSource>(repositoryUrl);
...
public:
    ...
    void offerUpdate(const Velopack::UpdateInfo &update)
    {
        ...
        QMessageBox message(
            ...
            UpdateController::tr(
                "WagleWaglePaint %1 is available. "
    ...
    void startDownload(const Velopack::UpdateInfo &update)
    {
        ...
        auto *progress = new QProgressDialog(
            UpdateController::tr("Downloading update…"),
            QString(),
            0,
            100,
            window);
        ...
        watcher->setFuture(QtConcurrent::run(
            [update](QPromise<DownloadResult> &promise) {
                ...
                try {
                    ...
                    promise.addResult(DownloadResult {
                        {},
                        QString::fromUtf8(error.what())
                    });
                }
    ...
    void applyUpdate(const Velopack::UpdateInfo &update)
    {
        ...
        const bool quitOnLastWindowClosed =
