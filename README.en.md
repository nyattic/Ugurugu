...
WagleWaglePaint is a drawing app where your pictures wiggle and move.
...
> [GitHub Issue](https://github.com/nyattic/WagleWaglePaint/issues) and tell
> us what you were doing and what happened. Attaching the `.wagle` file, when
...
| --- | --- | --- |
| Windows | Windows 10 or later, 64-bit | [Windows installer](https://github.com/nyattic/WagleWaglePaint/releases/latest/download/WagleWaglePaint-Windows-x64-Setup.exe) |
| macOS | macOS 14 or later, Apple Silicon | [macOS installer](https://github.com/nyattic/WagleWaglePaint/releases/latest/download/WagleWaglePaint-macOS-arm64.dmg) |
...
official [Releases page](https://github.com/nyattic/WagleWaglePaint/releases/latest).

### macOS

Open the DMG and drag WagleWaglePaint into the Applications folder. The macOS
...
- Save projects as `.wagle` files with layers and movement settings intact.
...
WagleWaglePaint suggests a `.wagle` file with the same name.
...
on Windows and **WagleWaglePaint → Settings** on macOS.
